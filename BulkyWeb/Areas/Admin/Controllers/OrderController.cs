	...
	public class OrderController : Controller {
        ...
        public IActionResult Details(int orderId) {
            OrderVM = new() {
                ...
                OrderDetail = _unitOfWork.OrderDetail.GetAll(u => u.OrderHeaderId == orderId, includeProperties: "Product,Company")
            };
        ...
        public IActionResult UpdateOrderDetail() {
            ...
            TempData["Success"] = "[報名明細]更新成功." + strResult;
        ...
        public IActionResult StartProcessing() {
            ...
            string strResult = _unitOfWork.Save();
            TempData["Success"] = "[報名資料]更新成功." + strResult;
        ...
        public IActionResult ShipOrder() {
            ...
            string strResult = _unitOfWork.Save();
            TempData["Success"] = "報名成功." + strResult;
            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
        }
        [HttpPost]
        [Authorize(Roles = SD.Role_Admin + "," + SD.Role_Employee)]
        public IActionResult CancelOrder() {
            ...
            string strResult = _unitOfWork.Save();
            TempData["Success"] = "[報名取消]成功." + strResult;
            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
        ...
        public IActionResult Details_PAY_NOW() 
        {
            ...
            OrderVM.OrderDetail = _unitOfWork.OrderDetail
                .GetAll(u => u.OrderHeaderId == OrderVM.OrderHeader.Id, includeProperties: "Product,Company");
